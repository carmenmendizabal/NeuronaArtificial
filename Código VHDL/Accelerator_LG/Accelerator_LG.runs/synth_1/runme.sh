...
HD_PWD='C:/Users/Carmen/Desktop/Memoria/Codigo_VHDL/Accelerator_LG/Accelerator_LG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AND_LG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AND_LG.tcl
