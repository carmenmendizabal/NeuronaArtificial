...
HD_PWD='C:/Users/Carmen/Desktop/Memoria/Codigo_VHDL/Accelerator_LG/Accelerator_LG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AND_LG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AND_LG.tcl -notrace
